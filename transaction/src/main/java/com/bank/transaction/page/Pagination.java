...
public class Pagination {
	...
	/*
	 * @Override public String toString() { return "Pagination [rowCount=" +
	 * rowCount + ", pageCount=" + pageCount + ", totalCount=" + totalCount +
	 * ", page=" + page + ", startPage=" + startPage + ", endPage=" + endPage +
	 * ", totalPageCount=" + totalPageCount + ", isPrev=" + isPrev + ", isNext=" +
	 * isNext + ", offset=" + offset + ", item_Name=" + item_Name + "]"; }
	 */
}
