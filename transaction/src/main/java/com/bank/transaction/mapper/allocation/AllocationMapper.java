...
public interface AllocationMapper {
        ...
        **/
        ...
        /**
        * @packageName    : com.bank.transaction.mapper.allocation(배당내역)
        * @fileName       : allocationInsert(배당내역 상세 수정)
        * @author         : Jihun Park
        * @date           : 2024.09.17
        * @description    :
        * ===========================================================
        ...
        * 2024.09.17        Jihun Park       최초 생성
        **/
        public int  allocationUpdate(Map<String, Object> map);
        /**
        * @packageName    : com.bank.transaction.mapper.allocation(배당내역)
        * @fileName       : tNoSelect(배당내역 상세 등록 일련번호)
        * @author         : Jihun Park
        * @date           : 2024.09.17
        * @description    :
        * ===========================================================
        ...
        **/
        ...
        /**
        * @packageName    : com.bank.transaction.mapper.allocation(배당내역)
        * @fileName       : allocationListcnt(배당내역 상세 등록전 중복 체크)
        * @author         : Jihun Park
        * @date           : 2024.09.17
        * @description    :
        * ===========================================================
